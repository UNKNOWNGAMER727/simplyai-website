...
const phases = [
  ...
  },
  {
    ...
    cost: '$16.67/mo',
    tools: ['SkipCalls ($16.67/mo)', 'Google Calendar sync'],
    tasks: [
      'Sign up for SkipCalls ($199/yr)',
      'Set up FAQ responses (pricing, availability)',
      'Connect Google Calendar for booking',
      'Set up SMS notifications for new calls',
