...
const phases = [
  ...
  },
  {
    ...
    cost: '~$9–22/mo',
    tools: ['Bland AI ($0.09/min)', 'Google Calendar sync'],
    tasks: [
      'Sign up for Bland AI',
      'Set up inbound call handler (FAQs, pricing, booking)',
      'Build outbound cold call script for leads',
      'Connect calendar for appointment booking',
      'Get a business phone number',
      'Set up follow-up call automation',
    ],
  },
  {
    number: '03',
