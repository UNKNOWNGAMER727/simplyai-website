...
const tiers = [
  {
    ...
    desc: 'Perfect for one computer. Up and running fast.',
    features: [
      'Perplexity AI installed & set up on 1 device',
      'Account creation & privacy settings configured',
      '45-minute hands-on tutorial',
      'Top 10 tricks walkthrough',
  ...
  },
  {
    ...
    desc: 'More devices, more time, tailored to how you work.',
    popular: true,
    features: [
      'Perplexity AI set up on up to 3 devices',
      'Account creation & privacy settings on all devices',
      '90-minute personalized training session',
      'Custom tips for your specific use case',
      'Bookmarks, shortcuts & workflow setup',
      'Quick-start cheat sheet to keep',
    ],
  },
  {
    ...
    desc: 'For small businesses that want the whole team using AI.',
    features: [
      'Perplexity AI set up on up to 10 devices',
      'Account creation & privacy settings on all devices',
      '2-hour deep-dive training session',
      'Custom prompt library built for your business',
      'Team workflow tips & best practices',
